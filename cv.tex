...
% \section{Projects}
% \begin{itemize}[leftmargin=*]
%     \headingSubItem{UPMEM}{During the first year of Master, I worked on evaluating a \textit{Processing-in-Memory} architecture using the \textit{k-means} algorithm.}
% \end{itemize}
...
% \begin{itemize*}[leftmargin=*]
%   \basicItem{~French}{Mother tongue}
%   ~~~~~~~~~~
%   \basicItem{~English}{Fluent}
% \end{itemize*}
\begin{itemize}[leftmargin=*]
...
%   \basicItem{~Languages}{Scala, Python, Javascript, C++, SQL, Java}
%   \basicItem{~Technologies}{Scala, Python, Javascript, C++, SQL, Java}
% \end{itemize*}
\begin{itemize}[leftmargin=*]
